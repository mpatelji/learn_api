...
//
//     final usersIteamModel = usersIteamModelFromJson(jsonString);

import 'dart:convert';

List<UsersIteamModel> usersIteamModelFromJson(String str) => List<UsersIteamModel>.from(json.decode(str).map((x) => UsersIteamModel.fromJson(x)));

String usersIteamModelToJson(List<UsersIteamModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class UsersIteamModel {
  String? id;
  String? slug;
  ...
  factory UsersIteamModel.fromJson(Map<String, dynamic> json) => UsersIteamModel(
    id: json["id"],
    slug: json["slug"],
    ...
    links: json["links"] == null ? null : UsersIteamModelLinks.fromJson(json["links"]),
    likes: json["likes"],
...
class UsersIteamModelLinks {
  String? self;
  String? html;
  String? download;
  String? downloadLocation;

  UsersIteamModelLinks({
    this.self,
    this.html,
    this.download,
  ...
  factory UsersIteamModelLinks.fromJson(Map<String, dynamic> json) => UsersIteamModelLinks(
    self: json["self"],
    html: json["html"],
